...
<%
String opt="SLM_CLUSTERS";

int total_size=in.App.getMaxOf(" SLM_CLUSTERS");
...
PreparedStatement ps_D=con.prepareStatement("delete from  SLM_BATCH");

PreparedStatement ps_I=con.prepareStatement("insert into SLM_BATCH(STATE,LOCATIONCODE,MARITALSTATUS,SCORE,CANDIDATE_LABEL) values(?,?,?,?,?)");

String qry="select * from SLM_CLUSTERS";
Statement st=con.createStatement();	
ResultSet rs =st.executeQuery(qry);
ResultSetMetaData rd=rs.getMetaData();
%>
<h2>3-Itemset : SLM_BATCH</h2>
...
String LOCATIONCODE=rs.getString(2);
String MARITALSTATUS=rs.getString(3);
int POSITIVE=rs.getInt(4);
...
ps_I.setString(1,STATE);
ps_I.setString(2,LOCATIONCODE);
ps_I.setString(3,MARITALSTATUS);
ps_I.setInt(4,POSITIVE);
ps_I.setString(5,CLUSTER_LABEL);
ps_I.executeUpdate();
