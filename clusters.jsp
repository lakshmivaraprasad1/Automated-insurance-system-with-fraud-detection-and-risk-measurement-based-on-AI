  ...
  <div class="content1">
    <div class="content_resize1">
      <div class="mainbar1">
        <div class="article1">
        <h2>
 <li><a href="clusters1.jsp">CLUSTERIN-II</a></li>

</h2>

<%
String opt="State_Clusters";

int total_size=in.App.getCountOfAll(" RESPONSE='Yes'");
...
String qry="select * from State_Clusters";
Statement st=con.createStatement();	
	ResultSet rs =st.executeQuery(qry);
		ResultSetMetaData rd=rs.getMetaData();
%>
<h2>STATE_CLUSTERS</h2>
...
int POSITIVE=rs.getInt(2);
int NAGATIVE=rs.getInt(3);
...
else if(POSITIVE>=cw2 && POSITIVE<=cw3)
{
...
qry="select * from COVERAGE_CLUSTERS";
...
<td><%=row%></td>
<%
String COVERAGE=rs.getString(1);
int POSITIVE=rs.getInt(2);
int NAGATIVE=rs.getInt(3);
int TOTAL=rs.getInt(4);
String CLUSTER_LABEL=ClassLabels[0];
...
<!--
//////////////////////////////////////////////////
//EMPLOYMENTSTATUS_CLUSTERS
//////////////////////////////////////////////////
-->
<h2>VEHICAL_TYPE_CLUSTERS</h2>
...
qry="select * from VEHICAL_TYPE_CLUSTERS";
st=con.createStatement();	
	rs =st.executeQuery(qry);
		rd=rs.getMetaData();
%>
...
<td><%=row%></td>
<%
String VEHICAL_TYPE=rs.getString(1);
int POSITIVE=rs.getInt(2);
int NAGATIVE=rs.getInt(3);
int TOTAL=rs.getInt(4);
String CLUSTER_LABEL=ClassLabels[0];
...
qry="select * from VAHICALSTATUS_CLUSTERS";
st=con.createStatement();	
	rs =st.executeQuery(qry);
		rd=rs.getMetaData();
%>
...
<td><%=row%></td>
<%
String VAHICALSTATUS_CLUSTERS=rs.getString(1);
int POSITIVE=rs.getInt(2);
int NAGATIVE=rs.getInt(3);
int TOTAL=rs.getInt(4);
String CLUSTER_LABEL=ClassLabels[0];
...
qry="select * from LOCATION_CLUSTERS";
st=con.createStatement();	
	rs =st.executeQuery(qry);
		rd=rs.getMetaData();
%>
...
<td><%=row%></td>
<%
String LOCATION_CLUSTERS=rs.getString(1);
int POSITIVE=rs.getInt(2);
int NAGATIVE=rs.getInt(3);
int TOTAL=rs.getInt(4);
String CLUSTER_LABEL=ClassLabels[0];
